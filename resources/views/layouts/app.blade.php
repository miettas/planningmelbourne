...
<head>
    ...
    @vite(['resources/scss/app.scss', 'resources/scss/knox.scss', 'resources/scss/app.scss', 'resources/scss/bankgothic_medium.scss', 'resources/js/app.js', 'resources/js/picturefill.min.js'])
